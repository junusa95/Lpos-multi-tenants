...
class SupplierController extends Controller
{
    ...
    public function supplier($supplier_id,$year = null){
        ...
        //reords of purchases
        $dataRecords = [];
        $records = ShopStoreSupplier::where('shop_id',$supplier->shop_id)->where('supplier_id',$supplier->id)->whereYear('added_at', $thisyear)->groupBy(DB::raw('Date(added_at)'))->orderBy('created_at','desc')->get();
