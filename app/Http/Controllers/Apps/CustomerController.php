...
class CustomerController extends Controller
{
    ...
    public function getCustomer($cusromer_id,$shop_id){
        ...
        $data['debt'] = $data['customer']->debt->sum('debt_amount');
        $data['interest'] = $data['customer']->debt->sum('interest_amount');
        $data['total_dept'] = $data['debt'] + $data['interest'];
        $data['activities'] = $this->customerActivities($shop_id,$cusromer_id);

        // $data['total_paid'] = $data['customer']->debt->sum('amount_paid');
        // $data['total_stock'] = $data['customer']->debt->sum('stock_value');
